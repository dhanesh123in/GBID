...
create_lag_demands <- function (data_src,data_gen,src_wk,cdataf,pdataf,type='train') {
  
  if (type!='test2') {data_src=merge(data_src,data_gen[Semana==(src_wk-1),.(pred1_1=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID,Ruta_SAK)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID', 'Ruta_SAK'))}
  data_src=merge(data_src,data_gen[Semana==(src_wk-2),.(pred1_2=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID,Ruta_SAK)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID', 'Ruta_SAK'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-3),.(pred1_3=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID,Ruta_SAK)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID', 'Ruta_SAK'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-4),.(pred1_4=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID,Ruta_SAK)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID', 'Ruta_SAK'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-5),.(pred1_5=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID,Ruta_SAK)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID', 'Ruta_SAK'))
  
  if (type!='test2') {data_src=merge(data_src,data_gen[Semana==(src_wk-1),.(pred2_1=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID'))}
  data_src=merge(data_src,data_gen[Semana==(src_wk-2),.(pred2_2=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-3),.(pred2_3=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-4),.(pred2_4=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-5),.(pred2_5=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID,Agencia_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID', 'Agencia_ID'))
  
  if (type!='test2') {data_src=merge(data_src,data_gen[Semana==(src_wk-1),.(pred3_1=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID'))}
  data_src=merge(data_src,data_gen[Semana==(src_wk-2),.(pred3_2=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-3),.(pred3_3=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-4),.(pred3_4=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID'))
  data_src=merge(data_src,data_gen[Semana==(src_wk-5),.(pred3_5=mean(Demanda_uni_equil)),by=.(Cliente_ID,Producto_ID)],all.x=T,by=c('Cliente_ID', 'Producto_ID'))
