...
data1<-data[Semana>7 & Semana<11,.(Semana=Semana+1,Cliente_ID,Producto_ID,target)]
...
if(TRUE){
  data1<-data[Semana>6 & Semana<10,.(Semana=Semana+2,Cliente_ID,Producto_ID,target)]
  ...
  data1<-data[Semana>5 & Semana<9,.(Semana=Semana+3,Cliente_ID,Producto_ID,target)]
  ...
  data1<-data[Semana>4 & Semana<8,.(Semana=Semana+4,Cliente_ID,Producto_ID,target)]
  ...
  data1<-data[Semana>3 & Semana<7,.(Semana=Semana+5,Cliente_ID,Producto_ID,target)]
